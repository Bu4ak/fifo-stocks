<template>
        <v-col class="pa-1 ma-2" cols="12" sm="12" md="12" >
            ...
            >
                <v-card>
                    <v-card-text>
                        <v-text-field outlined :rules="priceRules" v-model="price" type="number" :min="0.001" step="0.001" label="Price"></v-text-field>
                        <v-col class="pa-0" cols="6" sm="6" md="6">
                            <v-text-field outlined :rules="countRules" v-model="count" type="number" :min="1" step="1" label="Count"></v-text-field>
                        </v-col>
                        <v-btn style="bottom: 15px" :disabled="!valid" absolute right color="#ffdd2d" @click="addEntry">
                            <v-icon color="#333">fa-plus</v-icon>
                        </v-btn>
                    </v-card-text>
                </v-card>
            </v-form>
